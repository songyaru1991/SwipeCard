...
<body>
	...
	<form  action="alter_password.php" method="post" class="form-horizontal" onsubmit="return alter()">
		...
		确认新密码<input type="password" name="assertpassword" id="assertpassword"/><br/> 
